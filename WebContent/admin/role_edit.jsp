...
<!-- general form elements -->
              <div class="box box-primary">
                ...
                <form  name="roleForm" id="roleForm" method="post">
                	...
                	<input type="hidden" name="dateCreated" value="${role.dateCreated }"> 
                  <div class="box-body">
                  
                    <div class="form-group">
                      <label for="">角色名称</label>
                      <input type="text" class="form-control" name="roleName" id="" value="${role.roleName }" placeholder="name">
                    </div>
                    
                    <div class="form-group">
                      <label for="">角色说明</label>
                      <input type="text" class="form-control" name="comment" id="" value="${role.comment }" placeholder="comment">
                    </div>
