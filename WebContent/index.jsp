...
<link
	...
	rel="stylesheet" type="text/css" />
<!-- Theme style -->
<link href="${pageContext.request.contextPath}/js/dist/css/AdminLTE.min.css" rel="stylesheet" type="text/css" />
<!-- AdminLTE Skins. Choose a skin from the css/skins 
         folder instead of downloading all of them to reduce the load. -->
<link href="${pageContext.request.contextPath}/js/dist/css/skins/_all-skins.min.css" rel="stylesheet"
	type="text/css" />
<!-- iCheck -->
<link href="${pageContext.request.contextPath}/js/plugins/iCheck/flat/blue.css" rel="stylesheet"
	type="text/css" />
<!-- Morris chart -->
<link href="${pageContext.request.contextPath}/js/plugins/morris/morris.css" rel="stylesheet" type="text/css" />
<!-- jvectormap -->
<link href="${pageContext.request.contextPath}/js/plugins/jvectormap/jquery-jvectormap-1.2.2.css"
	rel="stylesheet" type="text/css" />
<!-- Date Picker -->
<link href="${pageContext.request.contextPath}/js/plugins/datepicker/datepicker3.css" rel="stylesheet"
	type="text/css" />
<!-- Daterange picker -->
<link href="${pageContext.request.contextPath}/js/plugins/daterangepicker/daterangepicker-bs3.css"
	rel="stylesheet" type="text/css" />
...
<body class="skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index2.html" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				<span class="logo-mini"><b>A</b>ZH</span> <!-- logo for regular state and mobile devices -->
				<span class="logo-lg"><b>Admin</b>YZH</span>
			</a>
					...
					<ul class="nav navbar-nav">
							...
							<ul class="dropdown-menu">
								...
								<li>
									...
									<ul class="menu">
										...
										<li><a href="#">
												<div class="pull-left">
													<img src="${pageContext.request.contextPath}/js/dist/img/user3-128x128.jpg" class="img-circle"
														alt="user image" />
												</div>
												<h4>
										...
										<li><a href="#">
												<div class="pull-left">
													<img src="${pageContext.request.contextPath}/js/dist/img/user4-128x128.jpg" class="img-circle"
														alt="user image" />
												</div>
												<h4>
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								src="${pageContext.request.contextPath}/js/dist/img/user2-160x160.jpg" class="user-image"
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header"><img
									src="${pageContext.request.contextPath}/js/dist/img/user2-160x160.jpg" class="img-circle"
									alt="User Image" />
									<p>
				...
				<ul class="sidebar-menu">
					...
					<li class="active treeview"><a href="#"> <i
						...
						<ul class="treeview-menu">
							<li class="active"><a href="javascript:menuTo('user',1);" id="user" user_add="用户新增" user_list="用户列表" user_edit="用户编辑"><i
									class="fa fa-circle-o"></i>用户</a></li>
							<li><a href="javascript:menuTo('role',1);" id="role" role_add="角色新增" role_list="角色列表" role_edit="角色编辑"><i
									class="fa fa-circle-o"></i>角色</a></li>
							<li><a href="javascript:menuTo('module',1);" id="module" module_add="模块新增" module_list="模块列表" module_edit="模块编辑"><i
									class="fa fa-circle-o"></i>模块</a></li>
					...
					<li class="treeview"><a href="#"> <i class="fa fa-files-o"></i>
						...
						<ul class="treeview-menu">
							<li><a href="angular.jsp"><i
									class="fa fa-circle-o"></i> angular.jsp</a></li>
							<li><a href="angular1.jsp"><i
									class="fa fa-circle-o"></i> angular1.jsp</a></li>
							<li><a href="admin/module_list.jsp"><i
									class="fa fa-circle-o"></i>module_list.jsp</a></li>
							<li><a href="angularjs/app/index.html"><i
									class="fa fa-circle-o"></i> angularjs index</a></li>
						</ul></li>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active" id="homePath">Dashboard</li>
				</ol>
			</section>
					...
					<section class="col-lg-7 connectedSortable">
						...
						<div class="box box-success">
							...
							<div class="box-body chat" id="chat-box">
								<!-- chat item -->
								<div class="item">
									<img src="${pageContext.request.contextPath}/js/dist/img/user4-128x128.jpg" alt="user image"
										class="online" />
									<p class="message">
								...
								<!-- chat item -->
								<div class="item">
									<img src="${pageContext.request.contextPath}/js/dist/img/user3-128x128.jpg" alt="user image"
										class="offline" />
									<p class="message">
										<a href="#" class="name"> <small
											class="text-muted pull-right"><i
								...
								<!-- chat item -->
								<div class="item">
									<img src="${pageContext.request.contextPath}/js/dist/img/user2-160x160.jpg" alt="user image"
										class="offline" />
									<p class="message">
										<a href="#" class="name"> <small
											class="text-muted pull-right"><i
	...
	<!-- 推送窗口 -->
	<div class="col-md-4" id="dialog" style="display:none;position:fixed; right:40px;bottom: 20px; width:250px;height:150px;">
              <div class="box box-solid">
                <div class="box-header with-border">
                  <h3 class="box-title">您收到一条信息</h3>
                  	<div class="pull-right box-tools">
						<button class="btn btn-info btn-sm" onclick="clock()" data-widget="" data-toggle="tooltip" title="" data-original-title="关闭">
							<i class="fa fa-times"></i>
						</button>
					</div>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <ul class="list-unstyled" id="massegelist">
                    <li>这里是推送窗口！</li>
	...
	<!-- Sparkline -->
	<script src="${pageContext.request.contextPath}/js/plugins/sparkline/jquery.sparkline.min.js"
		type="text/javascript"></script>
	<!-- jvectormap -->
	<script src="${pageContext.request.contextPath}/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"
		type="text/javascript"></script>
	<script src="${pageContext.request.contextPath}/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"
		type="text/javascript"></script>
	<!-- jQuery Knob Chart -->
	<script src="${pageContext.request.contextPath}/js/plugins/knob/jquery.knob.js" type="text/javascript"></script>
	<!-- daterangepicker -->
	<script
		src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.2/moment.min.js"
		type="text/javascript"></script>
	<script src="${pageContext.request.contextPath}/js/plugins/daterangepicker/daterangepicker.js"
		type="text/javascript"></script>
	<!-- datepicker -->
	<script src="${pageContext.request.contextPath}/js/plugins/datepicker/bootstrap-datepicker.js"
		type="text/javascript"></script>
	<!-- Bootstrap WYSIHTML5 -->
	<script
		...
		type="text/javascript"></script>
	<!-- Slimscroll -->
	<script src="${pageContext.request.contextPath}/js/plugins/slimScroll/jquery.slimscroll.min.js"
		type="text/javascript"></script>
	<!-- FastClick -->
	<script src='${pageContext.request.contextPath}/js/plugins/fastclick/fastclick.min.js'></script>
	<!-- AdminLTE App -->
	<script src="${pageContext.request.contextPath}/js/dist/js/app.min.js" type="text/javascript"></script>

	<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
	<script src="${pageContext.request.contextPath}/js/dist/js/pages/dashboard.js" type="text/javascript"></script>
